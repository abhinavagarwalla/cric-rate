	...
	for file in feed_list:
		...
		for i in range(len(fl1ind)):
			...
			if bat_bowl_pair not in playerlist.keys():
				...
				playerlist[bat_bowl_pair]["balls"] = 0
				playerlist[bat_bowl_pair]["sixes"] = 0
				playerlist[bat_bowl_pair]["fours"] = 0
				playerlist[bat_bowl_pair]["dots"] = 0
				playerlist[bat_bowl_pair]["matches"] = list()
				# playerlist[bat_bowl_pair] = 0
			playerlist[bat_bowl_pair]["total"] += int(fl1ind[i][fl1ind[i].keys()[0]]["runs"]["total"])
			if file not in playerlist[bat_bowl_pair]["matches"]:
				playerlist[bat_bowl_pair]["matches"].append(file)
			if int(fl1ind[i][fl1ind[i].keys()[0]]["runs"]["total"]) == 6:
				playerlist[bat_bowl_pair]["sixes"] += 1
			elif int(fl1ind[i][fl1ind[i].keys()[0]]["runs"]["total"]) == 4:
				playerlist[bat_bowl_pair]["fours"] += 1
			elif int(fl1ind[i][fl1ind[i].keys()[0]]["runs"]["total"]) == 0:
				playerlist[bat_bowl_pair]["dots"] += 1
			# playerlist[bat_bowl_pair] += int(fl1ind[i][fl1ind[i].keys()[0]]["runs"]["total"])
			playerlist[bat_bowl_pair]["balls"] += 1
